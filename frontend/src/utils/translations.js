...
export const translations = {
  en: {
    ...
    infoPage: {
      ...
      step8Title: "8. Capital Management Setup",
      step8Desc: "Define your investment strategy for your capital. Filter which assets are invested and configure your capital yield assumptions.",
  ...
  fr: {
    ...
    infoPage: {
      ...
      step8Title: "8. Configuration de la Gestion du Capital",
      step8Desc: "Définissez votre stratégie d'investissement pour votre capital. Filtrez les actifs investis et configurez vos hypothèses de rendement du capital.",
