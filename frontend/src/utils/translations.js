...
export const translations = {
  ...
  fr: {
    ...
    infoPage: {
      ...
      subtitle: "Un assistant complet pour votre planifier votre retraite",
      ...
      step6Title: "Paramètres de retraite et choix de simulation",
      step6Desc: "Saisissez vos données AVS, LPP et 3a, puis choissez l'une des 4 options de simulation suivantes:\n\n1) Simuler mon équilibre financier en prenant ma retraite à la date légale\n2) Choisir une date de retraite correspondant à l'une des dates de retraite anticipée possibles de votre plan de pension\n3) Choisir une date de retraite indépendamment de vos plans de retraite anticipée possibles\n4) Calculer la date de retraite la plus précoce possible (solde au décès non négatif)",
