...
export const translations = {
  en: {
    ...
    infoPage: {
      ...
      step9Title: "9. Scenario verdict",
      step9Desc: "Get your personalized verdict: Can you quit? See your final projected balance, download a comprehensive PDF report, and make informed decisions.",
  ...
  fr: {
    ...
    infoPage: {
      ...
      step9Title: "9. Verdict du scénario",
      step9Desc: "Obtenez votre verdict personnalisé : Pouvez-vous partir ? Visualisez votre solde final projeté, téléchargez un rapport PDF complet et prenez des décisions éclairées.",
