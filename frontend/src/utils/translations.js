...
export const translations = {
  ...
  fr: {
    ...
    infoPage: {
      ...
      subtitle: "Un assistant complet pour votre planification de retraite",
      backToHome: "Retour à l'accueil",
      step1Title: "Informations personnelles",
      step1Desc: "Commencez par entrer votre date de naissance et votre genre. Ces informations sont utilisées pour calculer votre âge légal de retraite et votre espérance de vie.",
      ...
      step4Desc: "Listez vos dépenses par catégories : Logement, Impôts, Assurance Maladie, Alimentation, Transport, Loisirs, etc. Utilisez l'assistant pour estimer rapidement les coûts typiques selon votre style de vie.",
      step4SpinOffTitle: "Dépenses de Logement (option avancée)",
      step4SpinOffDesc: "Cette option permet d'estimer en détail vos dépenses immobilières en lien avec votre situation de propriétaire foncier.",
      ...
      step7SpinOffTitle: "Gestion du Capital (option avancée)",
      ...
      securityDesc: "Vos données financières ne quittent jamais votre appareil. Tous les calculs sont effectués localement, et vos données sont chiffrées avec un chiffrement AES-256 utilisant votre mot de passe comme seule clé. Nous ne pouvons pas accéder ou récupérer vos données.",
