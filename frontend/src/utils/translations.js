...
export const translations = {
  en: {
    ...
    infoPage: {
      ...
      step7SpinOffDesc: "An advanced optional feature that allows you to define the investment strategy of your assets and configure capital yield assumptions.",
  ...
  fr: {
    ...
    landing: {
      title: "quit?",
      subtitle: "Pouvez-vous vous permettre une retraite anticipée?",
    ...
    infoPage: {
      ...
      step4SpinOffTitle: "Dépenses de Logement (fonction avancée)",
      step4SpinOffDesc: "Un service optionnel permet d'éstimer en détail vos dépenses immobilières en lien avec votre situation de propriétaire foncier.",
      step5Title: "Actifs et épargne",
      step5Desc: "Saisissez vos actifs liquides et non-liquides, vos revenus futurs possibles (héritage) ou d'autres entrées ponctuelles.",
      step6Title: "Paramètres de retraite",
      step6Desc: "Entrez vos avoirs projetésde retraite AVS (assurance sociale suisse), LPP (prévoyance professionnelle), 3a (prévoyance privée). Spécifiez les montants, fréquences et plages de dates pour chaque source. Pour la prévoyance professionnelle flexible, vous pouvez saisir des détails sur les options de pré-retraite.",
      ...
      step7SpinOffTitle: "Gestion du Capital (fonction avancée)",
      step7SpinOffDesc: "Service optionnel qui permet de definir les stratégies d'investissement de vos actifs et de configurer leurs hypothèses de rendement.",
