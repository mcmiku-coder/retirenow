...
export const translations = {
  en: {
    ...
    infoPage: {
      ...
      step6Title: "6. Assets and Savings",
      step6Desc: "Define your liquid assets, non-liquid assets, and possible future income like inheritance or other one-time inflows. This information helps create a complete picture of your financial situation.",
      step7Title: "7. Retirement inputs",
      step7Desc: "Enter your AVS (Swiss social security), LPP (occupational pension), 3a (private pension) retirement assets. Specify amounts, frequencies, and date ranges for each source. For flexible occupational pension, you can input details about pre-retirement options.",
      step8Title: "8. Scenario Simulator",
      step8Desc: "The heart of \"can i quit?\" - Enter your savings and your transmission objectives. Either ask to calculate the earliest pre-retirement option, or use all the simulation options to look for an optimized retirement date matching your needs and financial feeds!",
      step9Title: "9. Data Review Before Simulation",
      step9Desc: "Review and fine-tune all your income and cost data before running the simulation. Adjust values, split income or cost periods, and ensure all information is accurate for the most precise retirement projections.",
      step10Title: "10. Scenario Verdict",
      step10Desc: "Get your personalized verdict: Can you quit? See your final projected balance, download a comprehensive PDF report, and make informed decisions.",
  ...
  fr: {
    ...
    infoPage: {
      ...
      step6Title: "6. Actifs et épargne",
      step6Desc: "Définissez vos actifs liquides, actifs non-liquides et revenus futurs possibles comme un héritage ou autres entrées ponctuelles. Ces informations aident à créer une image complète de votre situation financière.",
      step7Title: "7. Paramètres de retraite",
      step7Desc: "Entrez vos avoirs de retraite AVS (assurance sociale suisse), LPP (prévoyance professionnelle), 3a (prévoyance privée). Spécifiez les montants, fréquences et plages de dates pour chaque source. Pour la prévoyance professionnelle flexible, vous pouvez saisir des détails sur les options de pré-retraite.",
      step8Title: "8. Simulateur de scénarios",
      step8Desc: "Le cœur de \"can i quit?\" - Entrez votre épargne et vos objectifs de transmission. Demandez soit de calculer l'option de pré-retraite la plus précoce, soit utilisez toutes les options de simulation pour trouver une date de retraite optimisée correspondant à vos besoins et vos finances!",
      step9Title: "9. Revue des données avant simulation",
      step9Desc: "Révisez et ajustez toutes vos données de revenus et de coûts avant de lancer la simulation. Modifiez les valeurs, divisez les périodes de revenus ou de coûts, et assurez-vous que toutes les informations sont exactes pour obtenir les projections de retraite les plus précises.",
      step10Title: "10. Verdict du scénario",
      step10Desc: "Obtenez votre verdict personnalisé : Pouvez-vous partir ? Visualisez votre solde final projeté, téléchargez un rapport PDF complet et prenez des décisions éclairées.",
