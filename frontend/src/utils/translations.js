...
export const translations = {
  en: {
    ...
    infoPage: {
      ...
      step1Desc: "Start by entering your birth date and gender. This information is used to calculate your legal retirement age and life expectancy based on official statistics.",
      ...
      step4SpinOffTitle: "Housing Expenses (optional advanced feature)",
      step4SpinOffDesc: "An optional side-calculator accessible from the Costs page. Use this to calculate detailed Rent or Mortgage values if you need help estimating your housing budget.",
      ...
      step6Desc: "Enter your AVS (Swiss social security), LPP (occupational pension), 3a (private pension) retirement assets. Specify amounts, frequencies, and date ranges for each source. For flexible occupation pension, you can input details about pre-retirement options.",
      ...
      step7SpinOffTitle: "Capital Management Setup (optional advanced feature)",
      step7SpinOffDesc: "An advanced configuration accessible from Data Review. Define your investment strategy, filter which assets are invested, and configure capital yield assumptions.",
  ...
  fr: {
    ...
    infoPage: {
      ...
      step1Desc: "Commencez par entrer votre date de naissance et votre genre. Ces informations sont utilisées pour calculer votre âge légal de retraite et votre espérance de vie selon les statistiques officielles.",
      ...
      step3Title: "Sources de revenus actuels",
      ...
      step4SpinOffTitle: "Dépenses de Logement (fonctionnalité avancée optionnelle)",
      step4SpinOffDesc: "Une calculatrice annexe optionnelle accessible depuis la page Dépenses. Utilisez-la pour estimer en détail votre budget Loyer ou Hypothèque.",
      step5Title: "Actifs et épargne",
      step5Desc: "Définissez vos actifs liquides, actifs non-liquides et revenus futurs possibles comme un héritage ou autres entrées ponctuelles. Ces informations aident à créer une image complète de votre situation financière.",
      step6Title: "Paramètres de retraite",
      ...
      step7Desc: "Révisez et ajustez toutes vos données de revenus et de coûts avant de lancer la simulation. Modifiez les valeurs, divisez les périodes de revenus ou de coûts, et assurez-vous que toutes les informations sont exactes pour obtenir les projections de retraite les plus précises.",
      step7SpinOffTitle: "Configuration Gestion du Capital (fonctionnalité avancée optionnelle)",
      step7SpinOffDesc: "Une configuration avancée accessible depuis la Revue des Données. Définissez votre stratégie d'investissement, filtrez les actifs investis et configurez vos hypothèses de rendement.",
      step8Title: "Verdict du scénario",
