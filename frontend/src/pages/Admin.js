...
import PromoClipAdmin from './admin/PromoClipAdmin'; // Import configuration tool
...
const Admin = () => {
  ...
  // ... (handleLogin, loadData, handleDeleteUser, handleLogout remain same)
      ...
      <div className="w-full max-w-[95%] mx-auto">
        ...
        <div className="flex space-x-2 mb-8 border-b border-border">
          <button
            ...
            className={`pb-2 px-4 text-sm font-medium transition-colors relative ${activeTab === 'users'
          ...
          <button
            ...
            className={`pb-2 px-4 text-sm font-medium transition-colors relative ${activeTab === 'promo'
                ? 'text-primary border-b-2 border-primary'
                : 'text-muted-foreground hover:text-foreground'
              }`}
          >
