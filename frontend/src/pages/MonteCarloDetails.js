                ...
                <div className="grid md:grid-cols-4 gap-4">
                    <Card className="bg-slate-900/50 border-slate-800">
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-slate-500 mt-1">Paths simulated</p>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="bg-slate-900/50 border-slate-800">
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-white">{settings?.step || 'Monthly'}</div>
                            <p className="text-xs text-slate-500 mt-1">Discrete frequency</p>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="bg-slate-900/50 border-slate-800">
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-white">{historyInfo?.sampleSize || 0} months</div>
                            <p className="text-xs text-slate-500 mt-1">Aligned dataset size</p>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="bg-slate-900/50 border-slate-800">
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-white">
                                {Math.round(settings?.horizonMonths / 12)} years
                            </div>
                            <p className="text-xs text-slate-500 mt-1">{settings?.horizonMonths} months</p>
                        </CardContent>
                    </Card>
                </div>
                                ...
                                <tbody>
                                    {assetStats?.map(asset => (
                                        <tr key={asset.id} className="border-b border-slate-800/50 hover:bg-slate-800/20 transition-colors">
                                            ...
                                            <td className="px-4 py-3 text-right text-amber-500/80">{asset.maxDrawdown.toFixed(2)}%</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
